  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const ctx = gsap.context(() => {
        ...
        gsap.set(q(".part-front"), { yPercent: -34, scale: 0.94 });
        gsap.set(q(".part-notch"), { scale: 0.8, rotate: 4 });
        ...
        assemble(".part-left", 1.05);
        assemble(".part-right", 1.2);
        assemble(".part-front", 1.45);
        assemble(".part-notch", 1.7);
