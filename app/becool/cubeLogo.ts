/* GARAGE BeCool 旧ロゴ(GBキューブ)のベクターデータ。
 * public/becool/img/symbol.svg から抽出。輪郭(logo-edge)を光らせて描く演出に使う。
 * B のカウンター(白抜き)を保つため fill-rule=evenodd の単一パス。 */
export const CUBE_VIEWBOX = "510 171 429 544";
export const CUBE_STOPS: [string, string][] = [
  ["0%", "#4A4F55"],
  ["55%", "#31557C"],
  ["100%", "#1F63B6"],
];
